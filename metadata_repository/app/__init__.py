...
from .routes import auth_routes, configuration_routes, core_routes, data_source_routes, destination_routes, \
    matcher_routes, test_file_routes, transfer_report_routes, transform_routes, user_routes

...
from app.matchers import scheme_and_host


class TestSchemeAndHostMatcher(unittest.TestCase):

    def testMatch(self):
        opts = dict(scheme="http", host="example.com")
        self.assertTrue(scheme_and_host.matches_url(opts, "http://example.com/file.txt"))
